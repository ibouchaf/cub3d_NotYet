...
LIBFT	=	libft/libft.a
SRCS	=	src/main.c src/parsing/parsing.c src/parsing/check_map.c src/parsing/parsing_utils.c src/utils/error_handler.c src/raycasting/raycasting.c src/raycasting/key_hook.c $(LIBFT)
